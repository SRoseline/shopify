{{-- la methode @Dump (Auth::user())permet d'afficher l'utilisateur en ligne --}}
{{-- @dump(Auth::user()) --}}
...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-success">
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavId">
       ...
       {{-- pour inserrer un lien DropDown --}}
          @else
           <ul class="nav">              
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  <form style="display:none" id="deconnexion" method="POST" action="{{route ('logout') }}">
                    {{--  pour éviter l'affichage de l'erreur 419 --}}
                    @csrf
                  </form>
...
<div class="container-fluid bg-dark mt-5 pt-4 pb-4 d-flex justify-content-center">
  ...
  © Copyright 2021 | Shopify | Tous dorits reservés
